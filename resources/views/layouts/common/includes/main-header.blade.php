    ...
    <ul class="nav navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown mr-30">
            ...
            <div class="dropdown-menu dropdown-menu-right">
                ...
                <a class="dropdown-item" href="{{route('logout')}}"  onclick="event.preventDefault();document.getElementById('admin_logout').submit()">
                    <i class="text-danger ti-unlock"></i>
                    Logout
                </a>
                <form method="post" action="{{route('logout')}}" style="display:none" id="admin_logout"> @csrf </form>
            </div>
        </li>
    </ul>
</nav>
