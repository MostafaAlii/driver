...
<div class="row">
    <div class="col-md-12 mb-30">
        <div class="card card-statistics h-100">
            <div class="card-body">
                <a href="" class="btn btn-success btn-sm" data-toggle="modal" data-target="#createNewServiceLocation" data-effect="effect-scale" role="button">
                    <i class="fa fa-plus"></i>
                    Add New {{ $title }}
                </a>
                @include('dashboard.serviceLocations.create')
                <br><br>
                <!--begin::Table-->
                {!! $dataTable->table([
